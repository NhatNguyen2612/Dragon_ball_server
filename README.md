...
```bash
git clone https://github.com/NhatNguyen2612/Dragon_ball_server/ && cd Dragon_ball_server && mv install.sh ~/../home/Dragon_ball_server/ && chmod +x ~/../home/Dragon_ball_server/install.sh && cd
```
